  ...
  <div class = "main-logged-2">
    <div class = "menu-logged">
      ...
      <div class = "header-class">
        <h1><span class="span-salmon">View</span> All<span class="span-salmon"> Employees</span></h1>
      </div>
      <div class="submission-form">
        <div class = "form-holder">
          <h2>Would You Like To View All Employees?</h2>
          <form action=<% request.getContextPath(); %>"Servlet" method="GET">
          	<input type="hidden" name="action" value="view-all-employees">
