...
<head>
  ...
  <title>Employee View Pending Request</title>
  ...
  <div class = "main-logged">
    <div class = "menu-logged">
      ...
      <div class = "header-class">
        <h1>View <span class="span-orange">Pending</span> Requests</h1>
      </div>
      <div class="submission-form">
        <div class = "form-holder">
          <h2>View Your Pending Requests?
          </h2>
          <form action=<% request.getContextPath(); %>"Servlet" method="GET">
          	<input type="hidden" name="action" value="view-pending-requests">
