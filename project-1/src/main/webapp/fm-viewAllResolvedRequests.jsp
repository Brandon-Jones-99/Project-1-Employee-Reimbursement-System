...
<head>
  ...
  <title>View All Resolved Requests</title>
  ...
  <div class = "main-logged-2">
    <div class = "menu-logged">
      ...
      <div class = "header-class">
        <h1><span class="span-salmon">View All Resolved</span> Requests</h1>
      </div>
      <div class="submission-form">
        <div class = "form-holder">
          <h2>View Resolved Requests?</h2>
          <form action=<% request.getContextPath(); %>"Servlet" method="GET">
          <input type="hidden" name="action" value="view-all-resolved">
